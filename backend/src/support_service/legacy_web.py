"""Legacy local web chat retained until the React client replaces it."""
...
<head>
    ...
    <title>Customer Support Assistant - AWS Bedrock</title>
    ...
    <div class="header">
        <div class="header-title">
            ...
            <div class="header-text">
                ...
                <p>customer support service &bull; Nova Pro</p>
            </div>
        </div>
